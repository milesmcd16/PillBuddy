...
class CaregiverRemove : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_caregiver_remove_buddy_page)
    }
    ...
    fun removeButton(view: View) {
        ...
        val buddyName = findViewById<EditText>(R.id.editTextTextPersonName90).text.toString()
